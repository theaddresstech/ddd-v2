<li class="kt-menu__item  kt-menu__item--submenu {{ is_active('users.*', true) }}" data-ktmenu-submenu-toggle="hover" aria-haspopup="true">
    ...
    <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">
        <ul class="kt-menu__subnav">
            <li class="kt-menu__item {{ is_active('users.create') }}" aria-haspopup="true">
                <a href="{{ route('users.create') }}" class="kt-menu__link ">
                    <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                    <span class="kt-menu__link-text">{{ __('main.add') }} {{ __('main.user') }}</span>
                </a>
            </li>
            <li class="kt-menu__item {{ is_active('users.index') }}" aria-haspopup="true">
