            ...
            <form>
                ...
                <div class="kt-grid-nav kt-grid-nav--skin-light">
                    <div class="kt-grid-nav__row">
                        <a href="{{route(userType()::prefix().'products.index')}}" class="kt-grid-nav__item">
                            ...
                            <span class="kt-grid-nav__title">products</span>
                            <span class="kt-grid-nav__desc"></span>
                        </a>
                        @admin
                            <a href="{{route(userType()::prefix().'orders.index')}}" class="kt-grid-nav__item">
                                <span class="kt-grid-nav__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                                ...
                                <span class="kt-grid-nav__title">Orders</span>
                            </a>
                        @endadmin
                        @vendor
                            <a href="{{route(userType()::prefix().'manage.vendor.user.order')}}" class="kt-grid-nav__item">
                                <span class="kt-grid-nav__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                    ...
                    <div class="kt-grid-nav__row">
                        @admin
                            <a href="{{route(userType()::prefix().'discounts.index')}}" class="kt-grid-nav__item">
                                <span class="kt-grid-nav__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                                ...
                                <span class="kt-grid-nav__title">Discounts</span>
                                <span class="kt-grid-nav__desc"></span>
                            </a>
                            <a href="{{route(userType()::prefix().'coupons.index')}}" class="kt-grid-nav__item">
                            <span class="kt-grid-nav__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <span class="kt-grid-nav__title">Coupons</span>
                            <span class="kt-grid-nav__desc"></span>
                        </a>
                        @endadmin
                        @vendor
                            <a href="{{route(userType()::prefix().'manage.vendor.my.products.out_of_stock')}}" class="kt-grid-nav__item">
                                    <span class="kt-grid-nav__icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
                                ...
                                <span class="kt-grid-nav__title">Product Out Stock</span>
                                <span class="kt-grid-nav__desc"></span>
                            </a>
                            <a href="{{route(userType()::prefix().'manage.vendor.my.products.low_stock')}}" class="kt-grid-nav__item">
                            <span class="kt-grid-nav__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <polygon points="0 0 24 0 24 24 0 24" />
                            ...
                            <span class="kt-grid-nav__title">Product Low Stock</span>
                            <span class="kt-grid-nav__desc"></span>
                        </a>
                        @endvendor
                    </div>
